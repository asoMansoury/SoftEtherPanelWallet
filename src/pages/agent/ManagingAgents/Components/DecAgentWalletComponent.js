...
const DecAgentWalletComponent = (props) => {
    ...
    async function btnSubmitHandler(e) {
        ...
        const result = await axios.post(apiUrls.agentUrl.decDebAgentWallet,obj);
    ...
    return <div>
        {
            ...
            <Grid container spacing={6}>
                <Grid item xs={12}>
                    <Card>
                        <CardHeader title="کاهش بدهی مشتری" titleTypographyProps={{ variant: 'h6' }} />
                        <Divider sx={{ margin: 0 }} />
                        {
                            error.isValid == false &&
...
export default DecAgentWalletComponent
