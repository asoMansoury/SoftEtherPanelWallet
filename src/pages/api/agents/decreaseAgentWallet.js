...
import { DecreaseAgentByAdmin, IncreaseAgentByAdmin, RefundSubAgent } from "src/databse/agent/RefundSubAgent";
...
export default async function handler(req, res) {
    ...
    if (req.method === 'POST') {
        ...
        const result = await DecreaseAgentByAdmin(money, agentcode, email, token.isAdmin);
